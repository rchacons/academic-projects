                ...
                <?php foreach ($data['artists'] as $artist) : ?>
                    <div class="artiste-item">
                        ...
                        <div class="artiste-img">
                            <img src="<?php echo URLROOT . '/' . $artist->picture ?>" alt="imgArtist" width="100" height="500">
                        </div>
                        <div class="artiste-text">
                            ...
                            <h2>
                                <?php echo 'Contact :<p>' . $artist->contact; ?>
                        </h2>
                            <h2>
                                <i>
                                <p><?php echo $artist->categoryId->name; ?> 
                                 - <?php echo $artist->categoryId->type; ?> </p>
                                </i>
                            </h2>
                            <p>
                            ...
                            <div class="artiste-social">
                                <a class="btn" href="<?php echo $artist->diffusion; ?>"></a>
                                <div class="artist-read-more"><a class="btn text-uppercase" href="ArtistePage.php">READ MORE</a></div>
                            </div>
