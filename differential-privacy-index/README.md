...
Groupe :   M1 MIAGE groupe D
* Roberto Henry Chacon Suarez   
* Manh-Huan Nguyen
* Hugo Thomas

Dans ce README.md, nous répondons aux questions du sujet 6 de SDB.  
...
3. Installer les dépendances Python dans l'environnement virtuel
```
...
Toutes les libraries à installer sont dans le requirements.txt, mais si jamais vous rencontrez des problèmes avec la librarie ```from Crypto.Cipher import AES```, veuillez à la réinstaller : 
